...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select().apis(RequestHandlerSelectors.basePackage("br.mil.defesa.apolo.interoperabilidade.controller") )
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("Microserviço Situação dos Militares - Marinha");
		apiInfoBuilder.description("Ponto de acesso aos dados da DPMM.");
