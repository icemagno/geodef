...
public class PentahoDataIntegration {
    ...
    private final static String JOBNAME = "/start_migracao_chm.kjb";
    private final static String JOBCLEARNAME = "/start_clear_temp_tables.kjb";
    private final static String SHARED_CONNECTIONS = "/shared.xml";
    
    
    public Object[] runJob(File produto){
        ...
        try {
            ...
            parameters.put("file", produto.getName());      
