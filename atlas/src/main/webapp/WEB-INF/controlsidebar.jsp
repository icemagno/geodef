	...
	<div class="tab-content">
		<form method="post">
			...
			<div class="form-group">
				<label class="control-sidebar-subheading"> Mapas de Base</label>
				<div class="box-body">
						...
						<div class="row">
							<div class="col-sm-6" style="padding:0px">
								<div style="position:relative;margin: 2px;">
									...
									<img class="img-responsive basemapimg" src="${midasLocation}/atlas/basemaps/bg_osm.jpg" alt="Photo">
								</div>
								<div style="position:relative;margin: 2px;">
									...
									<img class="img-responsive basemapimg" src="${midasLocation}/atlas/basemaps/bg_mosaico.jpg" alt="Photo">
								</div>
							</div>
							<div class="col-sm-6" style="padding:0px">
								<div style="position:relative;margin: 2px;">
									...
									<img class="img-responsive basemapimg" src="${midasLocation}/atlas/basemaps/bg_rapideye.jpg" alt="Photo">
								</div>
								<div style="position:relative;margin: 2px;">
									...
									<img class="img-responsive basemapimg" src="${midasLocation}/atlas/basemaps/bg_bdgex_orto.jpg" alt="Photo">
								</div>
							</div>
						</div>
						<div class="row">
