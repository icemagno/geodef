...
<%@ page pageEncoding="UTF-8" %>
	...
	<head>
	  ...
	  <title>SISGIDE - Geoportal|SisGEODEF</title>
	  ...
	  <!-- TOAST JQUERY -->
	  <link rel="stylesheet" type="text/css" href="/resources/css/jquery.toast.min.css">
	  
	  <!-- FLIGHT -->
	  <link rel="stylesheet" type="text/css" href="/resources/css/flightindicators.min.css">
