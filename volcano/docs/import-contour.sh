...
#gdal_contour -f PostgreSQL -a elevation -nln contour_gdal -i 10 srtm/S23W043.hgt "PG:host=volcano-db user=postgres password=admin dbname=volcano" -lco OVERWRITE=YES 
