...
for hgtfile in /home/srtm/prototipo/*.hgt; do
	...
	gdaldem hillshade -co TILED=YES -multidirectional -co compress=lzw -s 111120 -z 5 -combined -compute_edges $hgtname.tmp.tif $tifname
