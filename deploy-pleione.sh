...
-e no_proxy="172.22.1.44" \
-e JAVA_OPTS="-Dhttp.proxyHost=172.22.200.10 -Dhttp.proxyPort=3128 -Dhttps.proxyHost=172.22.200.10 -Dhttps.proxyPort=3128 -Dhttp.nonProxyHosts=\"localhost|172.22.1.44\" -Dhttps.nonProxyHosts=\"localhost|172.22.1.44\"" \
